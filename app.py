...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "The Patient is Diagnosis with Stage 0 Knee Osteoarthritis","result.html"        
    elif result == 1:
        return "The Patient is Diagnosis with Stage 1 Knee Osteoarthritis","result.html"
    elif result == 2:
        return "The Patient is Diagnosis with Stage 2 Knee Osteoarthritis","result.html"
    elif result == 3:
        return "The Patient is Diagnosis with Stage 3 Knee Osteoarthritis","result.html"
